 ...
 * lowerdelta*epsilon \param upperdelta set the maximum value for Cross-Validation search for optimal delta in smoothing
 * equal to upperdelta*epsilon \param print if set to true print on console the time required to process the output
 * \param n_threads the number of threads to be used by OPENMP. If negative, let OPENMP autonomously decide how many
 * threads to open
 */
//[[Rcpp::export]]

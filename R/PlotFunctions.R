...
#' @param kriging if set to FALSE suppress the computation and the plot of the kriging
...
plot.lsm<-function(model, a, z, d, n_points = 3, seed = 69, points_arrangement = "straight", n_threads = -1, kriging = TRUE)
{
